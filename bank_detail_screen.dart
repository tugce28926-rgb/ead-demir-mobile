          ...
          Expanded(
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    if (t.isPos)
                      Container(
                        ...
                        child: const Text('POS', style: TextStyle(fontSize: 8, fontWeight: FontWeight.bold, color: Color(0xFFD97706))),
                      ),
                    Expanded(
                      child: Text(
                ...
                Text(
                  (t.cariName.isNotEmpty && t.cariName != t.aciklama ? '${t.cariName} • ' : '') + DateFormat('dd.MM.yyyy').format(t.tarih),
